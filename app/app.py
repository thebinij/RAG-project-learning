...
async def lifespan(app: FastAPI):
    ...
    # Startup
    console.print("\n" + "="*60, style="bold blue")
    console.print("🚀 Starting LegendaryCorp AI Assistant (FastAPI)", style="bold green")
...
async def visualizer_dashboard(request: Request):
    ...
    try:
        ...
        return templates.TemplateResponse("dashboard.html", {"request": request, "stats": {"error": str(e)}})


@app.get("/visualizer/documents", response_class=HTMLResponse)
async def visualizer_documents(request: Request):
    """Documents page for ChromaDB visualizer"""
    return templates.TemplateResponse("documents.html", {"request": request})


@app.get("/visualizer/search", response_class=HTMLResponse)
async def visualizer_search(request: Request):
    """Search page for ChromaDB visualizer"""
    return templates.TemplateResponse("search.html", {"request": request})


@app.get("/visualizer/explore", response_class=HTMLResponse)
